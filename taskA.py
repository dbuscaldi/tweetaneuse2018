...
parser.add_argument("--lang", type=str, default="it", help="task language")
...
def main_train():
    if args.task2:
        all_data = ami_data.task2(train_file, 10)
    else:
        all_data = ami_data.task1(train_file, 10)
...
def main_test():
    if args.task2:
        all_data = ami_data.task2( args.test_file , 0)
    else:
        all_data = ami_data.task1( args.test_file, 0)
    ...
    for data in all_data.id_to_text_cat_map:
        ...
        #print('#', sent[0]) #debug: show sentences
